      ...
      <div className="relative h-[70vh] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
          <div className="container mx-auto max-w-5xl">
            <Badge className={`${post.categoryColor} hover:${post.categoryColor} rounded-full px-4 py-1.5 border-0 mb-6 text-sm font-semibold shadow-lg`}>
              {post.category}
            </Badge>
        ...
        <div className="mt-16 pt-8 border-t-2 border-gray-200">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-center sm:text-left">
              ...
              <p className="text-sm text-gray-500">Compártelo con quien lo necesite</p>
            </div>
            <Link href="/#blog">
              <Button 
                className="bg-teal-600 hover:bg-teal-700 text-white rounded-full px-8 py-6 text-base font-semibold shadow-lg hover:shadow-xl transition-all"
              >
