        ...
        <div className="grid lg:grid-cols-[1fr,1.5fr] gap-8 max-w-6xl mx-auto">
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-900 font-medium">Cali, Colombia</p>
                    <p className="text-sm text-gray-600">Av. 6 Norte #25-45</p>
                    <p className="text-sm text-gray-600">Barrio Granada</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-white border-gray-200">
            <CardContent className="pt-8">
              <h3 className="text-2xl font-bold mb-2">Solicita Información</h3>
              <p className="text-gray-600 text-sm mb-6">
                Completa el formulario y nos pondremos en contacto contigo en las próximas horas.
              </p>
              ...
              <form className="space-y-4">
                ...
                <Button className="w-full bg-teal-700 hover:bg-teal-800 text-white py-6 text-base font-medium">
                  <svg
                ...
                <p className="text-xs text-gray-500 text-center mt-4">
                  Al enviar este formulario, aceptas nuestros términos de privacidad y autorizas el contacto para fines comerciales.
                </p>
              </form>
            </CardContent>
          </Card>
