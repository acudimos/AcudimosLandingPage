        ...
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-100 leading-relaxed mb-6">
              Brindamos servicios especializados de cuidado domiciliario y
              acompañamiento para adultos mayores, combinando profesionalismo
              médico con calidez humana.
            </p>
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-teal-800 hover:bg-teal-700 rounded-lg flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                href="https://www.instagram.com/acudimos_adultos"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-teal-800 hover:bg-teal-700 rounded-lg flex items-center justify-center transition-colors"
